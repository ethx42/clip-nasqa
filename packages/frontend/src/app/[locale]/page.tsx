    ...
    <div className="flex min-h-[calc(100vh-53px)] flex-col">
      ...
      <section className="border-t border-border px-5 py-16">
        <ul className="mx-auto grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-3">
          {[
            { icon: '\u26A1', titleKey: 'landing.featureClipboardTitle', descKey: 'landing.featureClipboardDesc' },
            { icon: '\uD83D\uDCAC', titleKey: 'landing.featureQaTitle', descKey: 'landing.featureQaDesc' },
            { icon: '\uD83D\uDD13', titleKey: 'landing.featureNoSignupTitle', descKey: 'landing.featureNoSignupDesc' },
          ].map((feature) => (
            <li
