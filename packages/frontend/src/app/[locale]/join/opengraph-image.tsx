...
export default async function JoinOGImage() {
  const joinUrl = "https://clip.nasqa.io/join";
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 620 }}>
          ...
          >
            Enter the 6-digit code from your speaker
          </span>
      ...
      >
        ...
        >
          <img
            src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(joinUrl)}&bgcolor=09090b&color=fafafa&format=png`}
            width={200}
            height={200}
